...
curriculum_train_dataset = curriculum_train_dataset.shuffle(seed=SEED)
...
output_name = f"{model_id.split('/')[-1]}-random-{timestamp}"
wandb_name = f"random-sampling-{timestamp}"
